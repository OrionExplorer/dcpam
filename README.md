...
* DCPAM is multiplatform solution: on-premise (Linux/Windows) and cloud (Microsoft Azure, Amazon AWS, Google Cloud Platform) delpoyment is possible (even simultaneously).
...
* [x] Docker images for all the DCPAM Components.
...
| 2020 | :construction: Docker images for all the DCPAM Components   | In progress   |
