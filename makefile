...
sql_parser.o: src/DCPAM_WDS/sql_parser.c
	$(CC) -c src/DCPAM_WDS/sql_parser.c $(CFLAGS) $(ORACLE_DEP)
...
dcpam-wds: dcpam-wds.o socket_io.o cache.o mysql.o mariadb.o odbc.o postgresql.o log.o time.o http.o filesystem.o cJSON.o sqlite3.o memory.o db.o system.o strings.o oracle.o sqlite.o client.o lcs_report.o wds_node.o sql_parser.o
	@ mkdir bin -p
	$(CC) cache.o mysql.o socket_io.o mariadb.o odbc.o postgresql.o dcpam-wds.o log.o time.o http.o filesystem.o cJSON.o sqlite3.o memory.o db.o system.o strings.o oracle.o sqlite.o client.o lcs_report.o wds_node.o sql_parser.o -o bin/dcpam-wds $(LIBS)
